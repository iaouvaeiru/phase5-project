...
export default function NavBar() {
    return (
        <div>
            ...
            <NavLink to='/profile/offers' style={{ marginRight: '50px', fontSize: '15pt', color:'black' }} activeClassName="active" activeStyle={{fontWeight: "bold", color: "black"}}>Recieved Offers</NavLink>
            <NavLink to='/profile/orders' style={{ marginRight: '50px', fontSize: '15pt', color:'black' }} activeClassName="active" activeStyle={{fontWeight: "bold", color: "black"}}>Previous Orders</NavLink>
